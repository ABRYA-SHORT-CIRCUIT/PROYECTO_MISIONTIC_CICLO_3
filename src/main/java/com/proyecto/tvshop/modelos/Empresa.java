...
//
//    @OneToMany(mappedBy = "empresa", cascade = CascadeType.ALL)
//    private Set<MovimientoDinero> entTrans = new HashSet<>();
//
//    public Empresa() {
//    }
//
...
//    }
//
//    public Set<MovimientoDinero> getEntTrans() {
//        return entTrans;
//    }
//
//    public void setEntTrans(Set<MovimientoDinero> entTrans) {
//        this.entTrans = entTrans;
//        for (MovimientoDinero transX: entTrans) {
//            transX.getEmpresa();
//        }
//    }
//
